...
SECRET_KEY = 'd279dvr%mk@=5pvmb57i&u-ydvha01fhieo_b-rnxp#ohkv=#g'
...
#TEAM DOESN'T
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "static_cdn", "staticfiles") #'collect file here' #CDN /#AWS S3 Bucket
